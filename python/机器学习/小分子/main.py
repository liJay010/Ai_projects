...
def loadTestData(data,p):
    ...
    Features.to_csv('test.csv',index = None)
    if p == 1:
...
if __name__ == '__main__':
    trainFilePath = r"E:\Sougou\Molecule_prediction_20200312\Molecule_prediction_20200312\train_0312.csv"
    testFilePath = r"E:\Sougou\Molecule_prediction_20200312\Molecule_prediction_20200312\test_noLabel_0312.csv"
#    testFilePath = 'dataset/soccer/test.csv'
    data = loadDataset(trainFilePath)
    data = loadDataset(testFilePath)
